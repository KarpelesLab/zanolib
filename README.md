...
- **Deterministic threshold view key** — `ThresholdInputSigner::derive_view_secret()` derives a stable view secret from the shares (see above); tested to be identical across all parties and reproducible across runs.
